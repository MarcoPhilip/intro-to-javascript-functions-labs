...
const isCharAVowel = function(letter) {
    if (letter == "a") {
        return "True";
    }
    else if (letter == "e") {
...
const generateEmail = function(mail) {
    if (mail == "johnsmith") {
        return "johnsmith@example.com";
    } 
    else if (mail == "@example.com") {
        return "johnsmith@example.com"
    }
    else {
...
//start comparing the first two items (x and y)
//create a variable and store the bigger item into that variable

const maxOfThree = function(x, y, z) {
    let result = 0
// this is to store the result
    if (x >= y) { 
// if x is greater than y, make x the result
        result = x
        // console.log(result);
// compare result=x and z

    } else if (y >= x) {
        result = y
        // console.log(result);
    } 
    // compare both results to z 
     if (result <= z) {
        result = z
        // console.log(result);
...
console.log('Exercise 6 Result:', maxOfThree(5, 10, 85));
...
const basicCalculator = function(num1,num2,ops) {
    if (ops == "add") {
        return num1 + num2;
    }
    if (ops == "subtract") {
